...
use InstagramAPI\Model\Comment;
use InstagramAPI\Model\Like;
use InstagramAPI\Model\Location;
use InstagramAPI\Model\Media;
use InstagramAPI\Model\Story;
use InstagramAPI\Model\Tag;
use InstagramAPI\Model\UserStories;
